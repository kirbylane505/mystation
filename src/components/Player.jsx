...
export default function Player() {
  ...
  if (!currentTrack) {
    return (
      <div className="fixed bottom-0 left-0 right-0 h-16 md:h-20 bg-[#0a0f1a]/98 backdrop-blur-2xl border-t border-white/[0.06] flex items-center justify-center z-40">
  ...
  return (
    <>
      {/* MOBILE MINI PLAYER */}
      <div
        className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#0a0f1a]/98 backdrop-blur-2xl border-t border-white/[0.06]"
      ...
      {/* DESKTOP PLAYER */}
      <div className="hidden md:block fixed bottom-0 left-0 right-0 h-[88px] bg-[#0a0f1a]/98 backdrop-blur-2xl border-t border-white/[0.06] z-40">
