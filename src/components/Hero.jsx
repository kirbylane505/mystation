 ...
 * Navy blue & black theme with HQ animations
 */
    ...
    <div className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-6 py-24 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left: Text Content */}
          <div>
            <div className="foundation-badge mb-8 inline-flex items-center gap-2 animate-fade-in">
              <Sparkles size={14} />
              Mike Page Foundation
            </div>

            <h1 className="hero-title text-6xl md:text-8xl font-black text-white mb-8 font-display leading-[0.9] tracking-tight">
              MY<br/>
            ...
            {/* Stats */}
            <div className="hero-stats flex gap-12 mb-12">
            ...
            <div className="hero-cta flex flex-wrap gap-4">
              <button
                ...
                className="btn-primary flex items-center gap-3 hover-glow animate-glow-pulse"
              >
          ...
          <div className="relative hidden lg:block">
            <div className="relative w-full aspect-square max-w-lg mx-auto album-3d">
              {/* Main album card */}
              <div className="absolute inset-0 glass glow-blue-strong rounded-3xl p-8 album-3d-inner hover-glow-strong">
                <div className="w-full h-full bg-gradient-to-br from-blue-600/20 to-blue-900/40 rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="text-center z-10">
                    <div className="w-32 h-32 mx-auto mb-6 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center shadow-2xl animate-glow-pulse">
                  ...
                  {/* Decorative rings - spinning slowly */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-64 h-64 border border-white/5 rounded-full animate-spin-slow" style={{ animationDuration: '30s' }} />
                    <div className="absolute w-80 h-80 border border-white/5 rounded-full animate-spin-slow" style={{ animationDuration: '40s', animationDirection: 'reverse' }} />
                    <div className="absolute w-96 h-96 border border-white/5 rounded-full animate-spin-slow" style={{ animationDuration: '50s' }} />
                  </div>
                </div>
              </div>

              {/* Floating badges */}
              <div className="absolute -top-4 -right-4 px-4 py-2 bg-blue-500 rounded-full shadow-lg flex items-center gap-2 animate-bounce">
                <span className="text-white font-bold text-sm">NEW</span>
              </div>

              <div className="absolute -bottom-4 -left-4 px-5 py-3 glass rounded-2xl flex items-center gap-3 hover-glow animate-slide-up delay-500">
