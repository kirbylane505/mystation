...
export const tracks = [
  ...
  { id: 207, title: "It's My Bday Bitch", album: "Vault", year: 2026, albumId: 'vault', audioFile: '/audio/Mike Page x Krissie the Don x Chevy - Bday Bitch (x1.0).wav', featured: "Krissie the Don", producer: "The Cubist" },
  ...
  { id: 223, title: "BAP", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - BAP (Cubist x ARTteacher) (X2.1)L.wav', producer: "The Cubist x ARTteacher" },
  { id: 224, title: "MEG", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Impossible Dreamz 2024 159_Mike Page & King Deazel(X1.2).wav', featured: "King Deazel", producer: "The Cubist" },
  { id: 225, title: "You Niggaz Talk 2 Much", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/IDMG 664 -Mike Page (ruff01).wav', producer: "The Cubist" },
  { id: 226, title: "Play Ya Part", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/IDMG Mike Page 661 cubist (KSO mix3)L.wav', producer: "The Cubist" },
  { id: 227, title: "Lets Feast", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Impossible Dreamz 770 CUBIST PAGE_1.wav', producer: "The Cubist" },
  { id: 228, title: "None of Mine", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Impossible Dreamz 823_Mike Page (ruff02).wav', producer: "The Cubist" },
  { id: 229, title: "Bounce Back", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Impossible Dreamz 826_Mike Page_2.wav', producer: "The Cubist" },
  { id: 230, title: "Remain 10 Toes", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Impossible Dreamz 2024 103 Mike Page_(X1.1).wav', producer: "The Cubist" },
  { id: 231, title: "Sometime I", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Impossible Dreamz 2024 113_Mike Page_1.wav', producer: "The Cubist" },
  { id: 232, title: "Top Suite Wit The Balcony", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Impossible Dreamz 2024 39_Mike Page_X1.1.wav', producer: "The Cubist" },
  { id: 233, title: "Said It I Mean It", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Impossible Dreamz 2024 56_Mike Page_1.wav', producer: "The Cubist" },
  { id: 234, title: "Tribulations", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/IDMG Defoor 79 - Mike Page (ruff01).wav', producer: "The Cubist" },
  { id: 235, title: "Maximize My Position", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/IDMG Defoor 112 - Mike Page (ruff01).wav', producer: "The Cubist" },
  { id: 236, title: "What Happens In Vegas", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/IDMG418- Mike Page  (X1.2)L.wav', producer: "The Cubist" },
  { id: 237, title: "Win Win Win", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - idmg 511 (ruff01).wav', producer: "The Cubist" },
  { id: 238, title: "Be Yo Nigga Be My Homie", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page -idmg 226 (X1.1) L.wav', producer: "The Cubist" },
  { id: 239, title: "Don't Just Crash Out", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/IDMG Kirby 214 MP_IDMG_MASTER.wav', producer: "The Cubist" },
  // POP TRACKS
  { id: 240, title: "Divine", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - Divine_MASTERED.wav', producer: "The Cubist", genre: "Pop" },
  { id: 241, title: "Love Me", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - Love Me_MASTERED.wav', producer: "The Cubist", genre: "Pop" },
  { id: 242, title: "Shine On Me", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - Shine On Me_MASTERED.wav', producer: "The Cubist", genre: "Pop" },
  { id: 243, title: "In The City", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - In The City_MASTERED.wav', producer: "The Cubist", genre: "Pop" },
  { id: 244, title: "How Dat Feel", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - How Dat Feel_MASTERED.wav', producer: "Mike Page", genre: "Pop", openVerse: true },
  { id: 245, title: "Rent A Boat", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - Rent A Boat_MASTERED.wav', producer: "The Cubist", featured: "You", genre: "Pop", openVerse: true },
  { id: 246, title: "God Put Somethin N Me", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - God Put Somethin N Me_MASTERED.wav', producer: "The Cubist", genre: "Pop" },
  { id: 247, title: "Real Luv", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - Real Luv_MASTERED.wav', producer: "The Cubist", genre: "Pop" },
  { id: 248, title: "Kukuhki (Thankful)", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - Kukuhki (Thankful)_MASTERED.wav', producer: "The Cubist", genre: "Pop" },
  { id: 249, title: "Go With Love", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - Go With Love_MASTERED.wav', producer: "The Cubist", genre: "Pop" },
  { id: 250, title: "I Need Her", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - I Need Her_MASTERED.wav', producer: "Jack Thomas & The Cubist", genre: "Hip Hop" },
  { id: 251, title: "Club Clothes (Remake)", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - Club Clothes (Remake)_MASTERED.wav', producer: "The Cubist", genre: "Hip Hop" },
  { id: 252, title: "We've Been Thru It", album: "Vault", year: 2024, albumId: 'vault', audioFile: '/audio/Mike Page - We Been Thru It_MASTERED.wav', producer: "The Cubist", genre: "Hip Hop" },
];
...
export const featuredSong = {
  ...
  year: 2026,
  duration: "3:45",
  audioFile: '/audio/singles/Mike Page - Hope Yo Soul_MASTERED.wav',
