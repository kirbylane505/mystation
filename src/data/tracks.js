...
export const tracks = [
  ...
  // UNNAMED TRACKS REMOVED - Moved to Desktop/MASTER_TRACKS_TO_NAME for naming
  // Once named, add back to vault with proper titles
];
...
export const albums = [
  ...
  },
  {
    ...
    coverEmoji: "🔒",
    isNew: true,
    trackIds: [201, 202, 211],
    description: "Exclusive named tracks. Family & friends access with code FAMILY2026."
  }
];
