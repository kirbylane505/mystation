...
export const metadata = {
  ...
  description:
    "Stream Mike Page music for free. Official IDMG merch, Love on the Lawn Festival tickets, and exclusive content. All proceeds support youth music programs.",
  ...
  openGraph: {
    ...
    description:
      "Stream Mike Page music for free. Official merch, Love on the Lawn Festival tickets, and more. All donations support youth music programs.",
  ...
  twitter: {
    ...
    title: "MyStation | Stream Mike Page Music Free",
    description:
      "Stream Mike Page music for free. Official merch & Love on the Lawn Festival tickets.",
...
export default function RootLayout({ children }) {
  return (
    <html lang="en-US" className={`${montserrat.variable} ${inter.variable}`}>
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Stream music, shop merch, support youth. MyStation by Mike Page Foundation.",
              foundingDate: "2026",
              founder: {
                "@type": "Person",
                name: "Mike Page",
            ...
            __html: JSON.stringify({
              ...
              potentialAction: {
                ...
                target: {
                  "@type": "EntryPoint",
                  urlTemplate:
                    "https://mystationlive.com/search?q={search_term_string}",
                },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              genre: ["Hip-Hop", "R&B"],
              description:
                "Mike Page, hip-hop/R&B artist, founder of IDMG and the Love on the Lawn Festival",
              sameAs: [
                "https://instagram.com/idmgatl",
                "https://tiktok.com/@idmgatl",
              ],
