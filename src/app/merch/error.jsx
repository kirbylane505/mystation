...
export default function MerchError({ error, reset }) {
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Merch Store Error</h2>
        <p className="text-white/50 text-sm mb-6">Couldn't load the store. Please try again.</p>
