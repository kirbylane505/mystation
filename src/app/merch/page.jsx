...
export default function MerchPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ============ COMPLETE SETS — IDMG THE LABEL ============ */}
      <section className="py-16 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-mystation-black via-purple-950/20 to-mystation-black" />
        <div className="bg-orb w-[500px] h-[500px] bg-purple-600 top-[-100px] right-[-150px] opacity-30" />
        <div className="bg-orb w-[400px] h-[400px] bg-pink-500 bottom-[-100px] left-[-100px] opacity-20" style={{ animationDelay: '-5s' }} />

        <div className="relative max-w-screen-xl mx-auto px-6">
          <div className="text-center mb-10">
            <span className="inline-block px-4 py-1.5 bg-purple-500/10 border border-purple-500/30 rounded-full text-purple-300 text-sm font-bold mb-3 tracking-widest">IDMG THE LABEL</span>
            <h2 className="text-4xl lg:text-5xl font-black text-white mb-3">Complete Sets</h2>
            <p className="text-white/50 max-w-lg mx-auto">Full outfits. Matching top & bottom. Wear the brand head to toe.</p>
          </div>

          {/* Main Sets Grid */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">

            {/* Set 1: IDMG Tracksuit */}
            <div className="group relative rounded-2xl overflow-hidden border border-white/10 hover:border-purple-500/40 transition-all duration-500 hover:-translate-y-2" style={{ background: 'linear-gradient(135deg, rgba(30,10,60,0.8), rgba(20,20,40,0.9))' }}>
              <div className="relative aspect-square overflow-hidden">
                <Image
                  src="/images/merch/catalog/idmg-tracksuit-4colors.png"
                  alt="IDMG Tracksuit Set — 4 Colors"
                  width={600}
                  height={600}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                />
                <div className="absolute top-3 left-3 flex gap-2">
                  <span className="px-3 py-1 bg-purple-600/90 backdrop-blur-sm text-white text-xs font-bold rounded-full">SET</span>
                  <span className="px-3 py-1 bg-white/10 backdrop-blur-sm text-white text-xs font-bold rounded-full">4 COLORS</span>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
              <div className="p-5">
                <h3 className="text-xl font-black text-white mb-1">IDMG Tracksuit</h3>
                <p className="text-white/40 text-sm mb-3">Hoodie + Joggers — matching set</p>
                <div className="flex items-center gap-2 mb-3">
                  {['#FFFFFF', '#DC2626', '#C9A84C', '#1B3A5C'].map((c, i) => (
                    <span key={i} className="w-5 h-5 rounded-full border border-white/20" style={{ backgroundColor: c }} />
                  ))}
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-2xl font-black text-white">$119.98</span>
                    <span className="text-white/30 text-sm ml-2">top + bottom</span>
                  </div>
                  <Link href="#shop" className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white text-sm font-bold rounded-full transition-all hover:scale-105">
                    Shop
                  </Link>
                </div>
              </div>
            ...
            {/* Set 2: IDMG Short Set */}
            <div className="group relative rounded-2xl overflow-hidden border border-white/10 hover:border-pink-500/40 transition-all duration-500 hover:-translate-y-2" style={{ background: 'linear-gradient(135deg, rgba(30,10,60,0.8), rgba(20,20,40,0.9))' }}>
              <div className="relative aspect-square overflow-hidden">
                <Image
                  src="/images/merch/catalog/idmg-shortset-3panel.png"
                  alt="IDMG Short Set — 3 Colors"
                  width={600}
                  height={600}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                />
                <div className="absolute top-3 left-3 flex gap-2">
                  <span className="px-3 py-1 bg-pink-600/90 backdrop-blur-sm text-white text-xs font-bold rounded-full">SET</span>
                  <span className="px-3 py-1 bg-white/10 backdrop-blur-sm text-white text-xs font-bold rounded-full">9 COLORS</span>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
              <div className="p-5">
                <h3 className="text-xl font-black text-white mb-1">IDMG Short Set</h3>
                <p className="text-white/40 text-sm mb-3">Crewneck + Shorts — summer ready</p>
                <div className="flex items-center gap-2 mb-3">
                  {['#FFFFFF', '#000000', '#DC2626', '#EAB308', '#1B3A5C', '#9CA3AF'].map((c, i) => (
                    <span key={i} className="w-5 h-5 rounded-full border border-white/20" style={{ backgroundColor: c }} />
                  ))}
                  <span className="text-white/30 text-xs ml-1">+3</span>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-2xl font-black text-white">$89.98</span>
                    <span className="text-white/30 text-sm ml-2">top + bottom</span>
                  </div>
                  <Link href="#shop" className="px-4 py-2 bg-pink-600 hover:bg-pink-500 text-white text-sm font-bold rounded-full transition-all hover:scale-105">
                    Shop
                  </Link>
                </div>
              </div>
            ...
            {/* Set 3: IDMG Onesie */}
            <div className="group relative rounded-2xl overflow-hidden border border-white/10 hover:border-blue-500/40 transition-all duration-500 hover:-translate-y-2" style={{ background: 'linear-gradient(135deg, rgba(30,10,60,0.8), rgba(20,20,40,0.9))' }}>
              <div className="relative aspect-square overflow-hidden">
                <Image
                  src="/images/merch/catalog/idmg-onesie-4colors.png"
                  alt="IDMG Onesie — 4 Colors"
                  width={600}
                  height={600}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                />
                <div className="absolute top-3 left-3 flex gap-2">
                  <span className="px-3 py-1 bg-blue-600/90 backdrop-blur-sm text-white text-xs font-bold rounded-full">ONE PIECE</span>
                  <span className="px-3 py-1 bg-white/10 backdrop-blur-sm text-white text-xs font-bold rounded-full">4 COLORS</span>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
              <div className="p-5">
                <h3 className="text-xl font-black text-white mb-1">IDMG Onesie</h3>
                <p className="text-white/40 text-sm mb-3">Full zip onesie — lounge in luxury</p>
                <div className="flex items-center gap-2 mb-3">
                  {['#FFFFFF', '#DC2626', '#C9A84C', '#1B3A5C'].map((c, i) => (
                    <span key={i} className="w-5 h-5 rounded-full border border-white/20" style={{ backgroundColor: c }} />
                  ))}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-2xl font-black text-white">$79.99</span>
                    <span className="text-white/30 text-sm ml-2">one piece</span>
                  </div>
                  <Link href="#shop" className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold rounded-full transition-all hover:scale-105">
                    Shop
                  </Link>
                </div>
              </div>
          ...
          {/* Lifestyle Banner — Couple Shot */}
          <div className="relative rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-500">
            <div className="grid md:grid-cols-2 items-center">
              <div className="relative aspect-square md:aspect-auto md:h-full overflow-hidden">
                <Image
                  src="/images/merch/catalog/idmg-shortset-couple.png"
                  alt="IDMG Short Set — His & Hers"
                  width={800}
                  height={600}
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="p-8 md:p-12" style={{ background: 'linear-gradient(135deg, rgba(30,10,60,0.95), rgba(20,20,40,0.98))' }}>
                <span className="inline-block px-3 py-1 bg-white/10 text-white/70 text-xs font-bold rounded-full mb-4 tracking-wider">HIS & HERS</span>
                <h3 className="text-3xl lg:text-4xl font-black text-white mb-3">Match Your Energy</h3>
                <p className="text-white/50 mb-6 leading-relaxed">IDMG The Label — matching sets for couples, crews, and anyone who moves different. 9 colors. Premium cotton blend. Designed in Atlanta.</p>
                <div className="flex flex-wrap gap-3">
                  <Link href="#shop" className="inline-flex items-center gap-2 px-6 py-3 font-bold rounded-full text-white transition-all hover:scale-105" style={{ background: 'linear-gradient(135deg, #7C3AED, #EC4899)', boxShadow: '0 4px 20px rgba(124,58,237,0.4)' }}>
                    <ShoppingBag size={18} /> Shop All Sets
                  </Link>
                </div>
              </div>
            </div>
