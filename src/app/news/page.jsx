...
const posts = [
  ...
  },
  {
    ...
    categoryColor: 'blue',
    icon: Music,
    title: 'MyStation Is Live — Stream Now',
    excerpt: 'Our official music platform is live. Stream 100+ tracks, shop exclusive merch, and support the Mike Page Foundation with every play.',
    content: 'MyStation is now live at mystationlive.com. Preview 2 tracks free — subscribe starting at $4.99/mo to unlock the full 100+ track catalog. All proceeds support youth music programs, community meals, and scholarships through the Mike Page Foundation. Available as a PWA on mobile.',
    link: '/music',
