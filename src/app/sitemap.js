...
export default function sitemap() {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/playlists`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
    ...
    { url: `${baseUrl}/lounge`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.6 },
    { url: `${baseUrl}/contact`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
    { url: `${baseUrl}/vault`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
    { url: `${baseUrl}/street-team`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
