...
export default function sitemap() {
  ...
  const staticPages = [
    ...
    {
      url: `${baseUrl}/artists/the-cubist`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    ...
    // NOTE: /vault, /search, /street-team removed per SEO audit (2026-08-15) —
    // low-value / gated / search-endpoint routes. Still crawlable; stopped promoting.
  ];
